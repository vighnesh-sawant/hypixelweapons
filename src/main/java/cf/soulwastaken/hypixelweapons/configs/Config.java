...
public class Config {
    ...
    public static final String TELEPORT_WIDE = "hypixelweapons.teleport_wide";
    public static final String IMPLOSION_RADIUS = "hypixelweapons.implosion_radius";
    public static final String IMPLOSION_DAMAGE_LOWER_RANGE = "hypixelweapons.implosion_damage_lower_range";
    public static final String IMPLOSION_DAMAGE_HIGHER_RANGE = "hypixelweapons.implosion_damage_higher_range";
    public static final String ABILITY_DELAY = "hypixelweapons.ability_delay";
    public static final String WITHER_SHIELD_DELAY = "hypixelweapons.wither_shield_delay";
    public static final String PLAY_SOUND = "hypixelweapons.play_sound";
    public static final String PLAY_EFFECT = "hypixelweapons.play_effect";
    public static final String ITEM_NAME = "hypixelweapons.item_name";
    public String noPermMessage, blocksInWayMessage, abilityMessage, itemname;
    public int teleportwide, implosionradius, implosiondamagelower, implosiondamagehigher, abilitydelay, withershielddelay;
